...
module.exports = (socketIO, socket) => {
     const appDisconnect = async (payload, socketCallback) => {
          let runningGame;
          ...
          try {
               ...
               let resp = runningGame.onAppDisconnect(socket.userId);
     ...
     socket.on(socketEvents.rummy.appDisconnect, appDisconnect);
}
